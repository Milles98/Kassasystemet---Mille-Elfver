    ...
    public static class AdminMenu
    {
        public static void AdminTools(ProductServices productServices)
        {
            ...
            do
            {
                ...
                {
                    case 1:
                        ChangeProductName(productServices);
                        break;

                    case 2:
                        ChangeProductPrice(productServices);
                        break;

                    case 3:
                        AddProduct(productServices);
                        break;

                    case 4:
                        RemoveProduct(productServices);
                        break;

                    case 5:
                        AddDiscount(productServices);
                        break;

                    case 6:
                        RemoveDiscount(productServices);
                        break;
        ...
        private static void ChangeProductName(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
                ...
                BackToAdminMenuMessage();
                break;
            }
        }
        private static void ChangeProductPrice(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
        ...
        private static void AddProduct(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
        ...
        private static void RemoveProduct(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
        ...
        private static void AddDiscount(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
        ...
        private static void RemoveDiscount(ProductServices productServices)
        {
            while (true)
            {
                Console.Clear();
                ...
                string productId = GetUserInput("Ange 'Q' eller produkt ID: ").ToUpper();
                ...
                productServices.RemoveDiscount(productId);
        ...
        /// </summary>
        private static void BackToAdminMenuMessage()
        {
